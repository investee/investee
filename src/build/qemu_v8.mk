...
run-only:
	...
	cd $(BINARIES_PATH) && $(QEMU_BUILD)/aarch64-softmmu/qemu-system-aarch64 \
		-nographic \
		-serial tcp:127.0.0.1:$(QEMU_NW_PORT) -serial file:/src/sw-serial.log \
		-smp $(QEMU_SMP) \
		-s -machine virt,acpi=off,secure=on,mte=$(QEMU_MTE),gic-version=$(QEMU_GIC_VERSION),virtualization=$(QEMU_VIRT) \
		-cpu $(QEMU_CPU) \
